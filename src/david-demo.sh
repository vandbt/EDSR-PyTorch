...
python main.py --data_test Demo --cpu --debug --n_threads 2 --scale 2 --n_resblocks 32 --n_feats 256 --pre_train ../experiment/models/edsr_x2.pt --test_only --save_results
# python main.py --data_test Demo --cpu --scale 2 --n_resblocks 32 --n_feats 256 --pre_train ../experiment/models/EDSR_x2.pt --test_only --save_results
# python main.py --cpu --debug --data_test Demo --scale 2 --n_resblocks 32 --n_feats 256 --pre_train download --test_only --save_results
